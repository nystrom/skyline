        ...
        {daily.map((day, idx) => {
          ...
          return (
            <button
              ...
              className={`flex-1 min-w-[44px] flex flex-col items-center py-2.5 gap-0.5 border-b-2 transition-all duration-150 cursor-pointer ${
                isSelected
                  ? 'border-[color:var(--sky-fg)] opacity-100'
